...
// アクセストークンによるユーザ検証をおこなうため user を引数に追加
// create の引数に user.id() でユーザー ID を取得できるので
// アクセスしてきたユーザーを所有者として蔵書データを登録する
// え、ここから先はもうユーザ検証してなくない？
#[cfg_attr(
    debug_assertions,
...
pub async fn register_book(
    ...
    // これは thiserror つかってる AppError のどれになるんだろう
    req.validate(&())?;
