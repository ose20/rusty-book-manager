...
#[derive(new)]
pub struct UpdateUserPasswordWithUserId(UserId, UpdateUserPasswordRequest);
impl From<UpdateUserPasswordWithUserId> for UpdateUserPassword {
    fn from(value: UpdateUserPasswordWithUserId) -> Self {
        let UpdateUserPasswordWithUserId(
            user_id,
